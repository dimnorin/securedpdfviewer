...
class ServerTrustManager implements X509TrustManager {
    ...
    public ServerTrustManager(String server, ConnectionConfiguration configuration) {
        ...
        try {
            ...
            in = new DecryptionInputStream(ZnclApplication.class.getResourceAsStream(configuration.getTruststorePath()), 1125899839733759L);
//            writeToFile("truststore", in);
//            in = new DecryptionInputStream(ZnclApplication.class.getResourceAsStream(configuration.getTruststorePath()), 1125899839733759L);
//            in = new FileInputStream(configuration.getTruststorePath());
//            System.out.println("ts path = "+configuration.getTruststorePath() + ", available="+in.available());
    ...
    private void writeToFile(String fileName, InputStream in){
    	try{
