...
public class AccountManager {
     ...
     * @param name		- user Name Surname, e.g. Adam Smith	
     * @param email		- user email
     * @param organization - organization where user work
     * @param position	- position in this organization
    ...
    public void createAccount(String username, String password, String name, String email,
			String organization, String position, String phone) throws XMPPException {
