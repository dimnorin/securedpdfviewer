 ...
 * $RCSfile$
 * $Revision: 10876 $
 * $Date: 2008-11-13 10:31:37 -0800 (Thu, 13 Nov 2008) $
 *
...
import org.jivesoftware.smack.debugger.LiteDebugger;
        ...
        if (configuration.isDebuggerEnabled()) {
            if (debugger == null) {
                ...
                try {
                	...
                	try{
                	debugger = new LiteDebugger(this, writer, reader);
                	reader = debugger.getReader();
                    writer = debugger.getWriter();
                	}catch (Exception e1) {
                		e1.printStackTrace();
