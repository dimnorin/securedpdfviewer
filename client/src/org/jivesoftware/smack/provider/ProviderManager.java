...
public class ProviderManager {
    ...
    protected void initialize() {
        ...
        try {
            ...
            addIQProvider(IQDissProvider.ELEMENT_NAME, IQDissProvider.NAMESPACE, new IQDissProvider());
            addIQProvider(IQInitialLoadProvider.ELEMENT_NAME, IQInitialLoadProvider.NAMESPACE, new IQInitialLoadProvider());
            addIQProvider(IQDHProvider.ELEMENT_NAME, IQDHProvider.NAMESPACE, new IQDHProvider());
            addIQProvider(IQPdfFileProvider.ELEMENT_NAME, IQPdfFileProvider.NAMESPACE, new IQPdfFileProvider());
            addIQProvider(IQTimeTrackProvider.ELEMENT_NAME, IQTimeTrackProvider.NAMESPACE, new IQTimeTrackProvider());
            addIQProvider(IQUserInfoProvider.ELEMENT_NAME, IQUserInfoProvider.NAMESPACE, new IQUserInfoProvider());
            addIQProvider(IQFavoriteProvider.ELEMENT_NAME, IQFavoriteProvider.NAMESPACE, new IQFavoriteProvider());
            addIQProvider(IQStatisticsProvider.ELEMENT_NAME, IQStatisticsProvider.NAMESPACE, new IQStatisticsProvider());
            
            addIQProvider(StreamInitiation.ELEMENT_NAME, StreamInitiation.NAMESPACE_SI, new StreamInitiationProvider());
            addIQProvider(Bytestream.ELEMENT_NAME, Bytestream.NAMESPACE, new BytestreamsProvider());
        }
        catch (Exception e) {
            e.printStackTrace();
        }
