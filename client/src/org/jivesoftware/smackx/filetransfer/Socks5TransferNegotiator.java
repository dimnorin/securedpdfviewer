...
public class Socks5TransferNegotiator extends StreamNegotiator {
    ...
    InputStream negotiateIncomingStream(Packet streamInitiation)
       ...
       /* Bytestream streamResponse = createUsedHostConfirmation(
        ...
        //Activate
        Bytestream activate = createByteStreamActivate(streamHostsInfo.getPacketID(), streamHostsInfo.getTo(), streamHostsInfo.getFrom(), selectedHost.toString());
    ...
    private String createDigest(final String sessionID, final String initiator,
            final String target) {
    	String toHash = sessionID + StringUtils.parseName(initiator)
    	...
    	return StringUtils.hash(toHash);
    }
